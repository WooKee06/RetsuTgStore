...
const badgeVariantMap: Record<string, 'gold' | 'new' | 'sale' | 'hot' | 'trending' | 'limited' | 'bestseller'> = {
  NEW: 'new',
  SALE: 'sale',
  LIMITED: 'limited',
  ...
  if (layout === 'list') {
    return (
      ...
      >
        ...
        >
          <svg viewBox="0 0 24 24" className={cn(styles.heartIcon, isFavorite && styles.heartFilled)}>
